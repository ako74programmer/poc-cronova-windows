...
type Store interface {
	...
	// --- AI providers ---
	ListAIProviders(ctx context.Context) ([]*model.AIProvider, error)
	GetAIProvider(ctx context.Context, id string) (*model.AIProvider, error)
	UpsertAIProvider(ctx context.Context, p *model.AIProvider) error
