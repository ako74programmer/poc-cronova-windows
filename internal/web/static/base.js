...
const DICT = {
  zh: {
    ...
    nav_resources: "变量 & 连接", nav_audit: "审计", nav_api: "API", nav_ai_providers: "AI Provider", nv_ai_providers: "AI Provider",
    ai_title: "AI Provider", ai_sub: "配置一个 OpenAI 兼容的本地代理。令牌会被 AES-256-GCM 加密存储。",
    ai_id: "ID", ai_name: "显示名称", ai_url: "Base URL", ai_model: "模型", ai_token: "API Token", ai_default: "设为默认",
    ai_url_ph: "http://127.0.0.1:4141/v1", ai_model_ph: "如 gpt-4o-mini", ai_name_ph: "本地代理",
    ai_need_url: "请填写 Base URL", ai_need_model: "请填写模型", ai_need_token: "请填写 API Token",
    ai_save: "保存 Provider", ai_none: "还没有配置 AI Provider", ai_edit: "编辑 Provider", ai_add: "新建 Provider",
    ai_del_title: (n) => `删除 AI Provider“${n}”？`, ai_saved: "已保存", ai_deleted: "已删除",
    audit_sub: "运维操作记录:谁在何时对哪个工作流/运行做了什么。", audit_empty: "暂无操作记录", au_time: "时间", au_actor: "操作人", au_action: "操作", au_target: "对象",
    act_trigger: "触发", act_cancel: "取消", act_retry_run: "重跑运行", act_retry_task: "重跑任务", act_mark_task: "标记任务", act_mark_run: "标记运行", act_update_dag: "保存工作流", act_create_dag: "创建工作流", act_delete_dag: "归档工作流", act_pause: "暂停", act_unpause: "恢复", act_create_token: "创建 Token", act_delete_token: "撤销 Token", act_set_alert_group: "保存告警组", act_delete_alert_group: "删除告警组", act_set_ai_provider: "保存 AI Provider", act_delete_ai_provider: "删除 AI Provider",
