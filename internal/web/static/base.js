...
const DICT = {
  pl: {
    ...
    aiwiki_title: "AI wiki — cronova", aiwiki_sub: "Zadaj pytanie o cronova. Odpowiedź powstanie na podstawie dokumentacji i DAG-ów.", aiwiki_placeholder: "Zapytaj np. jak zrobić DAG…", aiwiki_send: "Wyślij", aiwiki_close: "Zamknij", aiwiki_speak: "Czytaj dokumentację", aiwiki_speak_unsupported: "Twoja przeglądarka nie obsługuje czytania tekstu.",
  ...
  en: {
    ...
    aiwiki_title: "AI wiki — cronova", aiwiki_sub: "Ask a question about cronova. The answer is built from the documentation and DAGs.", aiwiki_placeholder: "Ask something like how to create a DAG…", aiwiki_send: "Send", aiwiki_close: "Close", aiwiki_speak: "Read documentation", aiwiki_speak_unsupported: "Your browser does not support text-to-speech.",
